_base_ = [
    ...
    "../default/pipelines/default_camera_120m.py",
    "../default/models/default_camera_resnet50_no_lidar_fpn_120m.py",
...
experiment_name = "bevfusion_camera_resnet50_fpn_no_lidar_30e_8xb8_j6gen2_base_120m"
