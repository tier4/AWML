...
image_size = [480, 896]  # height, width
num_workers = 32
...
model = dict(
  ...
  #   ),
    ...
    img_aux_bbox_head=dict(
        ...
        loss_cls=dict(type="mmdet.GaussianFocalLoss", reduction="none", loss_weight=10.0),
        loss_bbox=dict(type="mmdet.L1Loss", reduction="mean", loss_weight=1.0),
        norm_bbox=True,
        tasks=[
...
load_from = "work_dirs/bevfusion_2_3/lidar_camera_merge_fixed.pth"
