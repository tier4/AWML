...
model = dict(
    ...
    img_roi_head=dict(
        ...
        loss_cls2d=dict(
            type="mmdet.QualityFocalLoss", use_sigmoid=True, beta=2.0, loss_weight=1.0 * focal_head_loss_weight
        ),
        loss_centerness=dict(
            type="mmdet.GaussianFocalLoss", reduction="mean", loss_weight=1.0 * focal_head_loss_weight
        ),
