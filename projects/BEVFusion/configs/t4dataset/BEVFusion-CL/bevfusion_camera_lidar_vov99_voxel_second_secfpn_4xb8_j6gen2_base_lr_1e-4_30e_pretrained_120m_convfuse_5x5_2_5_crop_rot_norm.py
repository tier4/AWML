...
work_dir = "work_dirs/bevfusion_2_5/" + _base_.dataset_type + "/bevfusion_camera_lidar_vov99_voxel_second_secfpn_4xb8_j6gen2_base_lr_1e-4_30e_pretrained_120m_convfuse_5x5_2_5_crop_rot_norm/"
...
model = dict(
    ...
    img_backbone=dict(
        ...
        spec_name="V-99-eSE",
        norm_eval=False, #ODO: make true by default
        frozen_stages=-1,
        input_ch=3,
        out_features=(
            "stage3",
    ...
    img_neck=dict(type="CPFPN", in_channels=[512, 768, 1024], out_channels=256, num_outs=3),
    view_transform=dict(
...
train_cfg = dict(
    by_epoch=True, max_epochs=max_epochs, val_interval=val_interval, dynamic_intervals=[(max_epochs - 3, 1)]
)
val_cfg = dict()
test_cfg = dict()
...
load_from = "work_dirs/bevfusion_merge/lidar_streampetr_merge.pth"
