_base_ = [
    ...
    "../default/schedulers/default_30e_8xb32_adamw_cosine_amp.py",
...
experiment_group_name = "bevfusion_lidar/gen1_base/" + _base_.dataset_type
experiment_name = "lidar_voxel_second_secfpn_30e_8xb32_gen1_base_120m_amp"
