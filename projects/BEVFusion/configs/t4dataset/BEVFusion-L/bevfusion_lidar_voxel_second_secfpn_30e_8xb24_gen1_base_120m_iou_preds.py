...
experiment_name = "lidar_voxel_second_secfpn_30e_8xb24_gen1_base_120m_iou_loss_iou_preds"
...
model = dict(
    ...
    bbox_head=dict(
        ...
        common_heads=dict(center=[2, 2], height=[1, 2], dim=[3, 2], rot=[2, 2], vel=[2, 2], iou_preds=[1, 2]),
    ),
)
