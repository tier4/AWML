...
class FocalHead(AnchorFreeHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Note that loss_bbox2d, bbox_iou2d, loss_center2d and assigner2d is not used in this auilliary
        """
    ...
    def loss(
        self, gt_bboxes2d_list, gt_labels2d_list, centers2d, depths, preds_dicts, img_pad_shapes, gt_bboxes_ignore=None
    ):
        """ "Loss function.
        Args:
        ...
        loss_dict["centers2d_loss"] = centers2d_losses
        loss_dict["centerness_loss"] = centerness_losses
    ...
    def aux_loss(
        ...
        enc_loss_cls, enc_losses_bbox, enc_losses_iou, centers2d_losses, centerness_losses = self.aux_loss_single(
            enc_cls_scores,
            enc_bbox_preds,
            pred_centers2d,
            centerness,
        ...
        loss_dict["img_2d_centerness_loss"] = centerness_losses
    ...
    def get_targets(
        ...
        img_pad_shape_list = [x for x in img_pad_shapes for _ in range(num_imgs)]
    ...
    def _get_target_single(
        ...
        assign_result = self.assigner2d.assign(
            bbox_pred, cls_score, pred_centers2d, gt_bboxes, gt_labels, centers2d, img_pad_shape, gt_bboxes_ignore
        )
