...
val_interval = 5
max_epochs = 30
work_dir = "work_dirs/centerpoint/" + _base_.dataset_type + "/second_secfpn_4xb16_121m_base_centerpoint_1_5_amp_e30/"
...
train_cfg = dict(
    by_epoch=True, max_epochs=max_epochs, val_interval=val_interval, dynamic_intervals=[(max_epochs - 10, 1)]
)
val_cfg = dict()
test_cfg = dict()
...
optim_wrapper = dict(
    ...
    optimizer=optimizer,
    clip_grad=clip_grad,
    loss_scale={"init_scale": 2.0**10, "growth_interval": 450},
)
