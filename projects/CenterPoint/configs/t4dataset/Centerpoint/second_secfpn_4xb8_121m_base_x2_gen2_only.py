_base_ = [
    ...
    "../../../../../autoware_ml/configs/detection3d/dataset/t4dataset/x2_gen2_only.py",
...
info_directory_path = "info/kokseang_1_4_x2_gen2_only/"
train_gpu_size = 2
train_batch_size = 8
test_batch_size = 2
num_workers = 32
val_interval = 5
max_epochs = 50
work_dir = "work_dirs/centerpoint/" + _base_.dataset_type + "/second_secfpn_4xb8_121m_base_centerpoint_1_4_x2_gen2_only/"
