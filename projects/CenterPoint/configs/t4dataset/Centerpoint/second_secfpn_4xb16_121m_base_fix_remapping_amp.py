...
info_directory_path = "info/kokseang_fix_mapping/"
train_gpu_size = 4
train_batch_size = 16
test_batch_size = 2
num_workers = 32
val_interval = 5
max_epochs = 50
work_dir = "work_dirs/centerpoint/" + _base_.dataset_type + "/second_secfpn_4xb16_121m_base_fix_remapping_amp/"
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        separate_head=dict(type="CustomSeparateHead", init_bias=-2.19*4.0, final_kernel=1),
...
# runtime settings
train_cfg = dict(by_epoch=True, max_epochs=max_epochs, val_interval=val_interval, dynamic_intervals=[(40, 2)])
val_cfg = dict()
test_cfg = dict()

optimizer = dict(type="AdamW", lr=lr, weight_decay=0.01, eps=1e-7)    
