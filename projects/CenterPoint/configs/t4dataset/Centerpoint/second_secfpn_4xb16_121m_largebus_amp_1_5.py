...
val_interval = 5
max_epochs = 50
work_dir = "work_dirs/centerpoint_1_5/" + _base_.dataset_type + "/second_secfpn_4xb16_121m_largebus_amp/"
...
vis_backends = [
    ...
    dict(
        ...
        exp_name="(KokSeangTan) CenterPoint 1.5",
        run_name="CenterPoint 1.5 largebus with 1.6 dataset",
