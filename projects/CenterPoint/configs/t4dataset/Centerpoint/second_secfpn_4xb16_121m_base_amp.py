...
val_interval = 5
max_epochs = 50
work_dir = "work_dirs/centerpoint/" + _base_.dataset_type + "/second_secfpn_4xb16_121m_base_centerpoint_1_5_amp/"
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        separate_head=dict(type="CustomSeparateHead", init_bias=-6.907, final_kernel=1),
