...
val_interval = 5
max_epochs = 50
work_dir = "work_dirs/centerpoint/" + _base_.dataset_type + "/second_secfpn_2xb8_121m_base_fix_mapping/"
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        separate_head=dict(type="CustomSeparateHead", init_bias=-2.19*1.5, final_kernel=1),
