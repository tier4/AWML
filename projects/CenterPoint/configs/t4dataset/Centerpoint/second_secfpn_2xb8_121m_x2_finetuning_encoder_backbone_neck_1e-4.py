...
info_directory_path = "info/kokseang_1_0/"
train_gpu_size = 2
train_batch_size = 4
test_batch_size = 2
num_workers = 32
val_interval = 1
max_epochs = 20
work_dir = "work_dirs/centerpoint_x2_finetuning/" + _base_.dataset_type + "/second_secfpn_2xb4_121m_x2_finetuning_encoder_backbone_neck_1e-4/"
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        norm_bbox=True,
        freeze_shared_conv=True,
        freeze_task_heads=True,
    ),
    train_cfg=dict(
        pts=dict(
            grid_size=grid_size,
