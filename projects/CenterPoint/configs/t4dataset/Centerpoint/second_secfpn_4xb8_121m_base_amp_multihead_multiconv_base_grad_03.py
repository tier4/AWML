...
max_epochs = 50
work_dir = (
    "work_dirs/centerpoint_multihead_multiconv_1_8/"
    + _base_.dataset_type
    + "/second_secfpn_4xb8_121m_base_amp_multihead_multiconv_base_grad_03/"
)
...
clip_grad = dict(max_norm=0.3, norm_type=2)  # max norm of gradients upper bound to be 15 since amp is used
