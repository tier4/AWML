...
class SampleData:
    ...
    sample_token: str
    detection_2d_boxes: List[Detection2DBox]
    ...
    def get_category_attr_counts(
        ...
        for detection_2d_box in self.detection_2d_boxes:
            box_category_name = detection_2d_box.box.semantic_label.name
            ...
            if box_category_name == category_name:
                for attr_name in detection_2d_box.attrs:
    ...
    def create_sample_data(
        ...
        :param detection_2d_boxes: List of 2D bounding boxes for the given sample token.
        """
        detection_2d_boxes = [Detection2DBox(box=box, attrs=box.semantic_label.attributes) for box in boxes]

        return SampleData(
            sample_token=sample_token,
            detection_2d_boxes=detection_2d_boxes,
        )
