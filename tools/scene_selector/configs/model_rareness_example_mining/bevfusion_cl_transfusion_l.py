camera_types = {
    'CAM_BACK_RIGHT', 'CAM_BACK_LEFT', 'CAM_BACK', 'CAM_FRONT',
    'CAM_FRONT_RIGHT', 'CAM_FRONT_LEFT'
}

bevfusion_CL_t4xx1_fusion_120m_v1 = dict(
    model=
    "/workspace/work_dirs/BEVFusion-CL_t4xx1_fusion_120m_v1/bevfusion_camera_lidar_voxel_second_secfpn_1xb1_t4xx1.py",
    weights=
    "/workspace/work_dirs/BEVFusion-CL_t4xx1_fusion_120m_v1/epoch_20.pth")
transfusion_lidar_20e_t4xx1_90m_768grid = dict(
    model=
    "/workspace/work_dirs/transfusion/transfusion_lidar_pillar_second_secfpn_1xb8-cyclic-20e_t4xx1_90m_768grid.py",
