...
class TestThresholdFilter:
    ...
    def test_init(self, mock_logger, sample_confidence_thresholds, sample_use_label):
        ...
        filter_obj = ThresholdFilter(
            confidence_thresholds=sample_confidence_thresholds,
            use_label=sample_use_label,
            logger=mock_logger
        )
    ...
    def test_basic_filtering(self, mock_logger, sample_confidence_thresholds, sample_use_label, 
                           sample_predicted_result_info):
    ...
    def test_empty_data(self, mock_logger, sample_confidence_thresholds, sample_use_label, 
                      empty_predicted_result_info):
    ...
    def test_filter_statistics_logging(self, mock_logger, sample_confidence_thresholds, 
                                      sample_use_label, sample_predicted_result_info):
    ...
    @pytest.mark.parametrize("confidence_threshold,expected_kept", [
    ...
    def test_various_thresholds_parametrized(self, mock_logger, sample_classes, 
